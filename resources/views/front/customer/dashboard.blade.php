...
<div class="container main-container">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <h2 class="section-title-inner"><span><i class="fa fa-unlock-alt"></i> My account </span></h2>
            <div class="row userInfo">
                <div class="col-xs-12 col-sm-12">
                    <p class="block-title-2"><span>Welcome to your account. Here you can manage all of your personal information and orders.</span></p>
                    <p>&nbsp;</p>
