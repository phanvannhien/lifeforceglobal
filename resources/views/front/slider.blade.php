...
<span class="arrowUnicode">►</span></a></div>
                        ...
                        <img src="{{ url('images/slider/slider1.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img"></div>
                    ...
                    <div class="slider-item slider-item-img2 ">
                        ...
                        <img src="{{ url('images/slider/slider3.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img"></div>
                    ...
                    <div class="slider-item slider-item-img3 ">
                        ...
                        <img src="{{ url('images/slider/slider4.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img"></div>
                    ...
                    <div class="slider-item slider-item-img3">
                        ...
                        <img src="{{ url('images/slider/6.jpg') }}" class="img-responsive parallaximg sliderImg" alt="img"></div>
                </div>
